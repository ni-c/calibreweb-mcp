 ...
 *
 * `openWorldHint: false` is the honest answer for this server: it talks to the
 * one Calibre-Web instance it is configured for and nowhere else. The
 * specification's own example draws the line there — a web search is an open
 * world, a store you point at is not.
 */
